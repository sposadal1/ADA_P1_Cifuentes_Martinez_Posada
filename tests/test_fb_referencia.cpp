...
int main() {
    ...
    // Contraseña "abc12" sobre alfabeto A2 (minusculas + digitos), n=5
    {
    ...
    // --- Test 2: Diccionario, caso donde la palabra SI esta en la lista ---
    {
        std::string alphabet_unused; // no aplica aqui
        // Hash de "abc12" (mismo de arriba), buscado ahora por diccionario
        std::string target_hash = "8d51feb34e3e69f6fa6dffc577e2c60490cf9a7fcd835f9f6af1505b71d74773";
        std::string dict_path = "resources/diccionario_test.txt";

        std::cout << "[Test 2] Diccionario - palabra presente en la lista...\n";
        ...
        if (result.found && result.password == "abc12") {
            ...
            std::cerr << "  FALLO. No se encontro 'abc12' en el diccionario de prueba.\n";
            fallos++;
        }
    }
